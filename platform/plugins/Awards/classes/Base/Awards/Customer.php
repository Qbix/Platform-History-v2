 ...
 * Instead, change the Awards_Customer.php file.
 *
 * @module Awards
 */
/**
...
abstract class Base_Awards_Customer extends Db_Row
{
	...
	{
		if (Q_Config::get('Db', 'connections', 'Awards', 'indexes', 'Customer', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Awards_Customer'))
		);
	}
