 ...
 *  @param {String} [$_REQUEST.publisherId=Q.Users.communityId] The publisherId of the Awards/product or Awards/service stream
 *  @param {String} [$_REQUEST.streamName] The name of the Awards/product or Awards/service stream
...
function Awards_payment_post($params = array())
{
	...
	$charge = Awards::charge($req['payments'], $req['amount'], $currency, compact(
		'token', 'stream'
	));
