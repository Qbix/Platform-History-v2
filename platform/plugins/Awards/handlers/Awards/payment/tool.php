 ...
 *  @param {string} [$options.image] The url pointing to a square image of your brand or product. The recommended minimum size is 128x128px. The recommended image types are .gif, .jpeg, and .png. *  @param {string} [$options.image] The url pointing to a square image of your brand or product. The recommended minimum size is 128x128px. The recommended image types are .gif, .jpeg, and .png.
 ...
 *  @param {string} [$options.billingAddress] Specify whether Stripe Checkout should collect the user's billing address (true or false). The default is false.
 *  @param {string} [$options.shippingAddress] Specify whether Checkout should collect the user's shipping address (true or false). The default is false.
 ...
 *  @param {string} [$options.allowRememberMe=true] Specify whether to include the option to "Remember Me" for future purchases (true or false).
 *  @param {string} [$options.bitcoin=false] Specify whether to accept Bitcoin (true or false). 
 *  @param {string} [$options.alipay=false] Specify whether to accept Alipay ('auto', true, or false). 
 *  @param {string} [$options.alipayReusable=false] Specify if you need reusable access to the customer's Alipay account (true or false).
 */
function Awards_payment_tool($options)
{
	...
	$paymentButton = Q::ifset($options, 'payButton', "Pay with " . $titles[$payments]);
