 ...
 * Instead, change the Users/Setting.js file.
 *
 * @module Users
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Users', 'indexes', 'Setting'], false)) {
		return new Db.Expression((withoutDbName ? '' : '{{dbname}}.')+'{{prefix}}setting');
	} else {
		var conn = Db.getConnection('Users');
		var prefix = conn.prefix || '';
		var tableName = prefix + 'setting';
 ...
 * @type string
 */
Base.prototype.className = "Users_Setting";
...
return [["varbinary","1023","",false],true,"",null];
};
