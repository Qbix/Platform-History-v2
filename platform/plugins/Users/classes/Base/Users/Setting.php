...
/**
 * Autogenerated base class representing setting rows
 * in the Users database.
 *
 * Don't change this file, since it can be overwritten.
 * Instead, change the Users_Setting.php file.
 *
 * @module Users
 */
/**
 * Base class representing 'Setting' rows in the 'Users' database
 * @class Base_Users_Setting
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Users_Setting extends Db_Row
{
	/**
	 * @property $userId
	 * @type string
	 ...
	 * @type string
	 * @default null
	 * JSON which can contain keys: read, write, and values are arrays of labels
	 */
	/**
	...
	{
		if (class_exists('Q_Config') and Q_Config::get('Db', 'connections', 'Users', 'indexes', 'Setting', false)) {
			return new Db_Expression(($with_db_name ? '{{dbname}}.' : '').'{{prefix}}'.'setting');
		} else {
			$conn = Db::getConnection('Users');
  			$prefix = empty($conn['prefix']) ? '' : $conn['prefix'];
  			$table_name = $prefix . 'setting';
  			if (!$with_db_name)
  				return $table_name;
  			$db = Db::connect('Users');
	...
	static function insertManyAndExecute($rows = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $rows,
			array_merge($options, array('className' => 'Users_Setting'))
		);
	}
...
return array (
  ...
  3 => NULL,
	...
	{
		$field_names = array('userId', 'name', 'content', 'access', 'insertedTime', 'updatedTime');
		$result = $field_names;
