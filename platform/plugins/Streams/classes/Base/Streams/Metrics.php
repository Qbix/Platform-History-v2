 ...
 * Instead, change the Streams_Metrics.php file.
 *
 * @module Streams
 */
/**
 * Base class representing 'Metrics' rows in the 'Streams' database
 * @class Base_Streams_Metrics
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Streams_Metrics extends Db_Row
{
	/**
	 * @property $userId
	 * @type string
	...
	static function insertManyAndExecute($rows = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $rows,
			array_merge($options, array('className' => 'Streams_Metrics'))
		);
	}
...
return array (
  ...
  3 => NULL,
	 ...
	 * @throws {Exception} An exception is thrown if $value is not string or is exceedingly long
	 */
	function beforeSet_metrics($value)
	{
		if (!isset($value)) {
		...
		if (!is_string($value) and !is_numeric($value))
			throw new Exception('Must pass a string to '.$this->getTable().".metrics");
		if (strlen($value) > 65535)
			throw new Exception('Exceedingly long value being assigned to '.$this->getTable().".metrics");
		return array('metrics', $value);			
	}
	 ...
	 * @return {array} [[typeName, displayRange, modifiers, unsigned], isNull, key, default]
	 */
	static function column_metrics()
	{
...
return array (
  ...
  3 => NULL,
	...
	{
		$field_names = array('userId', 'publisherId', 'streamName', 'insertedTime', 'updatedTime', 'metrics');
		$result = $field_names;
