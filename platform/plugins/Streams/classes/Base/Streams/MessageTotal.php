...
/**
 * Autogenerated base class representing message_total rows
 * in the Streams database.
 *
 * Don't change this file, since it can be overwritten.
 * Instead, change the Streams_MessageTotal.php file.
 *
 * @module Streams
 */
/**
 * Base class representing 'MessageTotal' rows in the 'Streams' database
 * @class Base_Streams_MessageTotal
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Streams_MessageTotal extends Db_Row
{
	/**
	...
	static function table($with_db_name = true, $alias = null)
	{
		if (Q_Config::get('Db', 'connections', 'Streams', 'indexes', 'MessageTotal', false)) {
			...
			$conn = Db::getConnection('Streams');
  			...
  			$table_name = $prefix . 'message_total';
  			if (!$with_db_name)
  				return $table_name;
	...
	static function select($fields=null, $alias = null)
	{
		...
		$q->className = 'Streams_MessageTotal';
		return $q;
	}
	...
	static function insertManyAndExecute($rows = array(), $options = array())
	{
		...
		self::db()->insertManyAndExecute(
			self::table(), $rows,
			array_merge($options, array('className' => 'Streams_MessageTotal'))
		);
	}
