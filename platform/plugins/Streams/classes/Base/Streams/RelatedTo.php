...
abstract class Base_Streams_RelatedTo extends Db_Row
{
	...
	{
		if (class_exists('Q_Config') and Q_Config::get('Db', 'connections', 'Streams', 'indexes', 'RelatedTo', false)) {
...
return array (
  ...
  3 => '{}',
	...
	{
		$field_names = array('toPublisherId', 'toStreamName', 'type', 'fromPublisherId', 'fromStreamName', 'weight', 'insertedTime', 'extra');
		$result = $field_names;
