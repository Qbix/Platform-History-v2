 ...
 * @param {String} [options.loadExtras=null] if "all", asks the server to load any extra scripts, stylesheets, etc. that are loaded on first page load. Can also be "response", "landing", "session" or combinations such as "response,session"
 ...
 *  @param {String} [options.loadExtras="response,session"] if "all", asks the server to load any extra scripts, stylesheets, etc. that are loaded on first page load. Can also be "response", "landing", "session" or combinations such as "response,session"
