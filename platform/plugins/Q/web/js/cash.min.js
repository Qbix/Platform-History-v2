...
o.fn.scrollLeft = function (v) {
    if (v === undefined) {
        return this[0].scrollLeft;
    }
    return o.fn.each.call(this, function () {
        this.scrollLeft = v;
    });
};

o.fn.scrollTop = function (v) {
    if (v === undefined) {
...
o.fn.data = function (k, v) {
    if (v === undefined) {
        var data = dataMap.get(this[0]);
        return (k === undefined) ? {} : (data && data[k]);
    }
    return o.fn.each.call(this, function () {
...
o.fn.submit = function () {
    this[0] && this[0].submit();
    return this;
};

var animationMap = new WeakMap();
o.fn.animate = function (properties, options) {
    // uses Q.Animation
    var special = {
        scrollLeft: true,
        scrollTop : true
    ...
    return o.fn.each.call(this, function () {
        ...
        for (var k in properties) {
            from[k] = special[k] ? this[k] : cs[k];
        }
        var animation = D.Q.Animation.play(
            function (x, y) {
                for (var k in properties) {
                    var t = special[k] ? element : element.style;
                    t[k] = from[k] + (properties[k] - from[k]) * y;
                }
            },
            options && options.duration || 300,
            options && options.easing || "swing"
        );
...
o.fn.stop = function () {
    var animation = animationMap.get(this[0]);
    if (animation) {
        animation.pause();
    }
    return this;
...
o.fn.click = function (callback) {
    this.on('click', callback);
};

D.jQuery = o; // spoof jQuery
}
)();