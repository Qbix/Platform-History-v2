            ...
            (function (global) {
                ...
                !function (e, t) {
                    ...
                    function j() {
                        ...
                        var a = {}, e = Object.prototype, s = e.hasOwnProperty,
                            f = Object.defineProperty || function (e, t, n) {
                                e[t] = n.value
                            }, t = "function" == typeof Symbol ? Symbol : {}, o = t.iterator || "@@iterator",
                            n = t.asyncIterator || "@@asyncIterator", r = t.toStringTag || "@@toStringTag";
                        ...
                        function u(e, t, n, r) {
                            var i, a, u, c, o = t && t.prototype instanceof p ? t : p, l = Object.create(o.prototype),
                                s = new x(r || []);
                            return f(l, "_invoke", {
                        ...
                        return f(g, "constructor", {
                            ...
                            constructor: x, reset: function (e) {
                                if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(E), !e) for (var t in this) "t" === t.charAt(0) && s.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = void 0)
                            }, stop: function () {
                                this.done = !0;
                    ...
                    (P = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : M).WeakMap || (T = Object.prototype.hasOwnProperty, O = Object.defineProperty && function () {
                        ...
                        O ? Object.defineProperty(e, t, {configurable: !0, writable: !0, value: n}) : e[t] = n
                    ...
                    }(L = {exports: {}}), L.exports), R = new WeakMap;
                    ...
                    var U = ["autopause", "autoplay", "byline", "color", "colors", "controls", "dnt", "height", "id", "interactive_params", "keyboard", "loop", "maxheight", "maxwidth", "muted", "volume", "playsinline", "portrait", "responsive", "speed", "texttrack", "title", "transparent", "url", "width"];
                    ...
                    var Y, Q, J, X = {
                        ...
                        return e(a, [{
                            ...
                            key: "init", value: (o = h(j().mark(function e(t, n, r) {
                                var o, i, a, u = this;
                                return j().wrap(function (e) {
                                    for (; ;) switch (e.prev = e.next) {
                                        case 0:
                            ...
                            key: "updateTimingObject", value: (n = h(j().mark(function e(t, n) {
                                return j().wrap(function (e) {
                                    for (; ;) switch (e.prev = e.next) {
                                        case 0:
                            ...
                            key: "updatePlayer", value: (r = h(j().mark(function e(t, n, r) {
                                var o, i, a;
                                return j().wrap(function (e) {
                                    for (; ;) switch (e.prev = e.next) {
                                        case 0:
                            ...
                            key: "maintainPlaybackPosition", value: function (a, u, e) {
                                var c = this, l = e.allowedDrift, s = e.maxAllowedDrift, t = e.minCheckInterval,
                                    f = e.maxRateAdjustment, d = e.maxTimeToCatchUp,
                                    n = 1e3 * Math.min(d, Math.max(t, s)), r = function () {
                            ...
                            key: "waitForTOReadyState", value: function (n, r) {
                                return new Promise(function (t) {
                                    !function e() {
                                        n.readyState === r ? t() : n.addEventListener("readystatechange", e, {once: !0})
                                    }()
                                })
                            }
                        }]), a
                        ...
                        return e(Player, [{
                            ...
                            key: "setColors", value: function (e) {
                            ...
                            key: "setTimingSrc", value: (n = h(j().mark(function e(t, n) {
                                var r, o = this;
                                return j().wrap(function (e) {
                                    for (; ;) switch (e.prev = e.next) {
                                        case 0:
                    ...
                    return n || (Y = function () {
                        ...
                        window.VimeoPlayerResizeEmbeds_ || (window.VimeoPlayerResizeEmbeds_ = !0, window.addEventListener("message", function (e) {
                            if (g(e.origin) && e.data && "spacechange" === e.data.event) for (var t = r.querySelectorAll("iframe"), n = 0; n < t.length; n++) if (t[n].contentWindow === e.source) {
                        ...
                        window.VimeoSeoMetadataAppended || (window.VimeoSeoMetadataAppended = !0, window.addEventListener("message", function (e) {
                            if (g(e.origin)) {
                                var t = D(e.data);
                                if (t && "ready" === t.event) for (var n = a.querySelectorAll("iframe"), r = 0; r < n.length; r++) {
                                    var o = n[r], i = o.contentWindow === e.source;
                        ...
                        window.VimeoCheckedUrlTimeParam || (window.VimeoCheckedUrlTimeParam = !0, a = function (e) {
                            ...
                            if (g(n.origin)) {
                                var e = D(n.data);
                                if (e && "ready" === e.event) for (var o = t.querySelectorAll("iframe"), i = 0; i < o.length; i++) !function () {
            ...
            (function (global) {
                ...
                var Vimeo = function (_Tech) {
                    ...
                    Vimeo.prototype.initVimeoPlayer = function initVimeoPlayer() {
                        ...
                        ['play', 'pause', 'ended', 'timeupdate', 'progress', 'seeked', 'seeking', 'waiting'].forEach(function (e) {
