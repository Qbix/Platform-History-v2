 ...
 * Instead, change the Broadcast/Message.js file.
 *
 * @module Broadcast
 */
...
function Base (fields) {
	 ...
	 * @type string
	 */
	this.className = "Broadcast_Message";
}
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Broadcast', 'indexes', 'Message'], false)) {
...
Base.prototype.beforeSave = function (value) {
	var fields = ['publisherId','streamName','ordinal','instructions'], i;
	if (!this._retrieved) {
