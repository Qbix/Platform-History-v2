 ...
 * Instead, change the Broadcast/User.js file.
 *
 * @module Broadcast
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Broadcast', 'indexes', 'User'], false)) {
 ...
 */
Base.prototype.beforeSet_friend_count = function (value) {
		if (!value) return value;
		if (value instanceof Db.Expression) return value;
		value = Number(value);
		if (isNaN(value) || Math.floor(value) != value)
			throw new Error('Non-integer value being assigned to '+this.table()+".friend_count");
		if (value < 0 || value > 4294967295)
			throw new Error("Out-of-range value '"+value+"' being assigned to "+this.table()+".friend_count");
		return value;
};
