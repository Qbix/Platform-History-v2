...
function Websites_0_8_Streams_mysql()
{
	...
	$streams = array(
		...
		"Websites/seo/" => array('type' => "Streams/template", "title" => "Website SEO", "icon" => Q_Html::themedUrl("Q/plugins/Websites/img/seo"), "content" => "", "deletable" => true),
		"Websites/header" => array('type' => "Streams/image/icon", "title" => "Header image", "icon" => Q_Html::themedUrl("Q/plugins/Websites/img/header"), "content" => ""),
