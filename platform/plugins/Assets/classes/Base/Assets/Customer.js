 ...
 * Instead, change the Assets/Customer.js file.
 *
 * @module Assets
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Assets', 'indexes', 'Customer'], false)) {
 ...
 * @type string
 */
Base.prototype.className = "Assets_Customer";
...
Base.prototype.beforeSet_customerId = function (value) {
		...
		if (value instanceof Db.Expression) return value;
		if (typeof value !== "string" && typeof value !== "number" && !(value instanceof Buffer))
			throw new Error('Must pass a String or Buffer to '+this.table()+".customerId");
