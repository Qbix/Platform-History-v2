...
abstract class Base_Assets_Credits extends Db_Row
{
	...
	{
		if (Q_Config::get('Db', 'connections', 'Assets', 'indexes', 'Credits', false)) {
...
return array (
  ...
  3 => '0000-00-00 00:00:00',
	...
	{
		$field_names = array('id', 'fromUserId', 'toUserId', 'publisherId', 'streamName', 'reason', 'credits', 'attributes', 'insertedTime', 'updatedTime');
		$result = $field_names;
