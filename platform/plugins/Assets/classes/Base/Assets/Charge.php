 ...
 * Instead, change the Assets_Charge.php file.
 *
 * @module Assets
 */
/**
...
abstract class Base_Assets_Charge extends Db_Row
{
	...
	static function insertManyAndExecute($rows = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $rows,
			array_merge($options, array('className' => 'Assets_Charge'))
		);
	}
...
return array (
  ...
  3 => '0000-00-00 00:00:00',
	...
	{
		$field_names = array('userId', 'id', 'description', 'attributes', 'insertedTime', 'updatedTime');
		$result = $field_names;
